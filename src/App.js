...
class App extends Component {
  ...
  getAllMovies = () => {
    axios
      .get('https://cryptic-eyrie-68367.herokuapp.com/getallmovies')
      .then(result => {
  ...
  onSubmit = e => {
    ...
    const query = `https://cryptic-eyrie-68367.herokuapp.com/getmovie?title=${
      this.state.title
    }`;
  ...
  removeMovie(title) {
    ...
    const query = `https://cryptic-eyrie-68367.herokuapp.com/deletemovie?title=${title}`;
    axios
      .get(query)
      .then(result => {
        this.getAllMovies();
